...
namespace SmartSchool_WebAPI.Data
{
    public class DataContext: DbContext
    {
        ...
        public virtual DbSet<AlunoDisciplina> AlunosDisciplinas { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Aluno>()
                .HasData(new List<Aluno>(){
                    new Aluno(1, "Marta", "Kent", "34556456"),
                    new Aluno(2, "Paula", "Isabela", "34556423"),
                    new Aluno(3, "Laura", "Antonia", "34556465"),
                    new Aluno(4, "Luiza", "Maria", "34556487"),
                    new Aluno(5, "Lucas", "Machado", "34556462"),
                    new Aluno(6, "Pedro", "Alvares", "34556472"),
                    new Aluno(7, "Paulo", "José", "34556494")
                });
