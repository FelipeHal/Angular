...
namespace SmartSchool.Core.Migrations
{
    ...
    [Migration("20211029223014_refreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartSchool.Core.BusinessEntities.UsuarioRefreshTokens", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("UsuarioRefreshTokens");
                });
            ...
            modelBuilder.Entity("SmartSchool.Core.BusinessEntities.Usuarios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Nome = "Usuário demo",
                            SenhaHash = "M6FO7xLxhdkYwU4pwJKriRvNSDvmKwaovgsqjmM8remcnhHD+hxHP4o/O5t1NfHG",
                            Usuario = "teste"
                        });
                });
            ...
            modelBuilder.Entity("SmartSchool.Core.BusinessEntities.UsuarioRefreshTokens", b =>
                {
                    b.HasOne("SmartSchool.Core.BusinessEntities.Usuarios", "Usuario")
